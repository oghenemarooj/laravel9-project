                    ...
                    <div class="row align-items-center">
                        <div class="col-7">
                            <div class="ingredients-img">
                                <img src="eco_assets/img/images/ingredients_img.jpg" alt="">
                        ...
                        <div class="col-5">
                            <div class="ingredients-content-wrap">
                                ...
                                <div class="ingredients-fact">
                                    <ul>
                                        <li>
                                            <div class="icon"><img src="eco_assets/img/icon/ing_icon01.png" alt=""></div>
                                            <div class="content">
                                                <h4>128+</h4>
                                        ...
                                        <li>
                                            <div class="icon"><img src="eco_assets/img/icon/ing_icon02.png" alt=""></div>
                                            <div class="content">
                                                <h4>35k+</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="newsletter-wrap">
                                ...
                                <img src="eco_assets/img/images/newsletter_shape01.png" alt="" class="newsletter-shape top-shape wow fadeInDownBig" data-wow-delay=".3s">
                                <img src="eco_assets/img/images/newsletter_shape02.png" alt="" class="newsletter-shape bottom-shape wow fadeInUpBig" data-wow-delay=".3s">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-5">
                            <div class="online-support-img">
                                <img src="eco_assets/img/images/support_img.png" alt="">
                            </div>
                        </div>
