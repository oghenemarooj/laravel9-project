<x-guest-layout>
    <main>
        ...
        <!-- slider-area -->
        <section class="slider--area" data-background="/eco_assets/img/bg/slider_area_bg.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="slider-active">
                            <div class="single-slider slider-bg content-right" data-background="/eco_assets/img/slider/slider__bg01.jpg">
                            ...
                            <div class="single-slider slider-bg" data-background="/eco_assets/img/slider/slider__bg02.jpg">
                                <div class="slider-content">
                            ...
                            <div class="single-slider slider-bg" data-background="/eco_assets/img/slider/slider__bg03.jpg">
                                <div class="slider-content">
                            ...
                            <div class="single-slider slider-bg" data-background="/eco_assets/img/slider/slider__bg04.jpg">
                                <div class="slider-content">
                                    <h5 class="sub-title" data-animation="fadeInUp" data-delay=".2s">top deal !</h5>
                    ...
                    <div class="row category-active">
                        <div class="col-lg-2">
                            <div class="category-item active">
                                ...
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img01.png" alt="">
                                </div>
                        ...
                        <div class="col-lg-2">
                            <div class="category-item">
                                <a href="shop.html" class="category-link"></a>
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img02.png" alt="">
                                </div>
                                <div class="category-content">
                        ...
                        <div class="col-lg-2">
                            <div class="category-item">
                                <a href="shop.html" class="category-link"></a>
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img03.png" alt="">
                                </div>
                                <div class="category-content">
                        ...
                        <div class="col-lg-2">
                            <div class="category-item">
                                <a href="shop.html" class="category-link"></a>
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img04.png" alt="">
                                </div>
                                <div class="category-content">
                        ...
                        <div class="col-lg-2">
                            <div class="category-item">
                                <a href="shop.html" class="category-link"></a>
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img05.png" alt="">
                                </div>
                                <div class="category-content">
                        ...
                        <div class="col-lg-2">
                            <div class="category-item">
                                <a href="shop.html" class="category-link"></a>
                                <div class="category-thumb">
                                    <img src="/eco_assets/img/product/category_img06.png" alt="">
                                </div>
                                <div class="category-content">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="discount-time-bg">
                            <div class="discount-time-img left"><img src="/eco_assets/img/images/discount_count_shape01.png" class="wow rollIn" data-wow-delay=".3s" alt=""></div>
                            <div class="discount-time-img right"><img src="/eco_assets/img/images/discount_count_shape02.png" alt=""></div>
                            <div class="discount-time-content">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6">
                        <div class="sp--product--item mb-50">
                            <div class="sp--product--thumb">
                                ...
                                <a href="shop-details.html"><img src="/eco_assets/img/product/bdw_products01.png" alt=""></a>
                            </div>
                            <div class="sp--product--content">
            ...
            <div class="container">
                <div class="ganic-app-wrap">
                    <div class="ganic-app-img">
                        <img src="/eco_assets/img/images/download_img.png" alt="">
                    </div>
                    <div class="row justify-content-end">
                        <div class="col-lg-6">
                            <div class="ganic-app-content">
                                <div class="shape"><img src="/eco_assets/img/images/app_download_shape.png" alt=""></div>
                                <span class="sub-title">Online Platform</span>
                                <h2 class="title"><span>download</span> ganic APP 2021</h2>
                                <div class="ganic-app-btn">
                                    <a href="index-2.html"><img src="/eco_assets/img/icon/app_btn01.png" alt=""></a>
                                    <a href="index-2.html"><img src="/eco_assets/img/icon/app_btn02.png" alt=""></a>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog-post-item mb-30">
                            <div class="blog-post-thumb">
                                <a href="blog-details.html"><img src="/eco_assets/img/blog/blog_post_thumb01.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog-post-item mb-30">
                            <div class="blog-post-thumb">
                                <a href="blog-details.html"><img src="/eco_assets/img/blog/blog_post_thumb02.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-9">
                        <div class="blog-post-item mb-30">
                            <div class="blog-post-thumb">
                                <a href="blog-details.html"><img src="/eco_assets/img/blog/blog_post_thumb03.jpg" alt=""></a>
                            </div>
                            <div class="blog-post-content">
